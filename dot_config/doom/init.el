...
(doom! :input
       ...
       ;; (format +onsave)  ; automated prettiness (probably deprecated)
       ...
       (org :editor evil +ipython +jupyter +journal +dragndrop +roam2 +noter +pretty +pandoc)               ; organize your plain life in plain text
